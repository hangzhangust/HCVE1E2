function energy_vs_fitness_E2(method, msa_aa_ex, msa_aa, phi_curr, mutant_order, ...
    H, ind_non_conserve)
...
if small==0
h = legend('Goffard2005','Drummer2006','Falkowska2007','Rothwangl2008','Rothwangl2008b',...
...
set(gca,'Position',[.1 .13 .6 .83]);  %调整 XLABLE和YLABLE不会被切掉
